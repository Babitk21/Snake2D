...
public class Snake2 : MonoBehaviour
{
    ...
    public static Snake2 Instance{ get; private set; }
    ...
    public void SetIsShieldActive(bool isShieldActive){
        this.isShieldActive = isShieldActive;
    }
    
    private bool isScoreBoostActive;
    ...
    private void HandleGridMovement() {
        ...
        if (gridMoveTimer >= gridMoveTimerMax) {
            ...
            bool snakeAteVenom = levelGrid.TrySnakeEatVenom(gridPosition);
            if (snakeAteFood) {
            ...
            if (snakeAteVenom && !isShieldActive){
                //snake ate venom, reduce body
                DeleteSnakeBodyPart();
                snakeBodySize--;
            }
            else if (snakeAteFood && isShieldActive){
    ...
    private void DeleteSnakeBodyPart(){
        if (snakeBodyPartList.Count > 0) {
            SnakeBodyPart lastSnakeBodyPart = snakeBodyPartList[snakeBodyPartList.Count - 1];
            snakeBodyPartList.RemoveAt(snakeBodyPartList.Count - 1);
            Destroy(lastSnakeBodyPart.transform.gameObject);
        }
    }
    ...
    private class SnakeBodyPart {
        ...
        public SnakeBodyPart(int bodyIndex) {
            ...
            Rigidbody2D rb= snakeBodyGameObject.AddComponent<Rigidbody2D>();
            BoxCollider2D collider2D = snakeBodyGameObject.AddComponent<BoxCollider2D>();
            collider2D.isTrigger = true;
            rb.gravityScale = 0;
            snakeBodyGameObject.tag = "Snake2";
